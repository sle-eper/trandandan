export function renderNavBar():string
{
    return ` <nav id="nav-bar" class="flex flex-row justify-around items-center" >
                ...
                <div class="basis-1/3 flex items-center">
                    <input class="w-[400px]  h-8 border-1 border-white rounded-s-lg text-white border-r-0" type="text" placeholder="Search">
                ...
                <div class="basis-15" >
                    <button class="w-10 h-10 rounded-full border-white border-1  bg-black hover:bg-[linear-gradient(to_right,#D73B3F,#FD1D1D,#711F21)] ">
